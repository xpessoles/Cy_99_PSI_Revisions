...
\def\xxpartie{Révision}

\def\xxnumchapitre{}%Chapitre 1 \vspace{.2cm}}
\def\xxchapitre{Roulement sans glissement}%\hspace{.12cm} Approche énergétique}
...
\def\xxtitreexo{Variateur de vitesse à sphères}%Motorisation du moteur Haibike}
...
\def\xxpied{%
Cycle 99 --Révisions% Modélisation mécanique -- Dynamique\\% afin de valider leurs performances.\\
...
%\ifprof
%\begin{center}
%\includegraphics[width=.5\linewidth]{images/train_01}
%\end{center}
%\else
%\begin{center}
